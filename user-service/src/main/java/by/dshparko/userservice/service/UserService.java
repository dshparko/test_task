...
public class UserService {
    ...
    public UserDto createUser(UserDto dto) throws JsonProcessingException {
        ...
        notificationProducer.sendUserEvent(UserAction.CREATE, mapper.toDto(user));
    ...
    public UserDto updateUser(Long id, UserDto dto) throws JsonProcessingException, AccessDeniedException {
        ...
        notificationProducer.sendUserEvent(UserAction.UPDATE, mapper.toDto(updated));
    ...
    public void deleteUser(Long id) throws JsonProcessingException, AccessDeniedException {
        ...
        notificationProducer.sendUserEvent(UserAction.DELETE, mapper.toDto(user));
    }

    private void verifyAccess(Long targetUserId) throws AccessDeniedException {
